...
static struct BlacklistEntry BlacklistedPrefixes[] = {
	 {0x8C26E281, 0x8C26E281, "IXAR1"},
	 {0xCAB06119, 0xCAB06119, "IXAR2"},
	 {0xA7DEDBB0, 0xA7DEDBB0, "IXAR3"},
	 {0xD74FED0D, 0xD74FED0D, "IXAR4"},
	 {0x6E1A3C23, 0x6E1A3C23, "IXAR5"},
	 {0x283A4302, 0x283A4302, "IXAR6"},
	 {0x99015DDA, 0x99015DDA, "IXAR7"},
   {0x72152D70, 0x72152D70, "IXAR8"},
   {0xEB3A5929, 0xEB3A5929, "IXAR9"},
   {0x0D19320B, 0x0D19320B, "IXAR10"},
   {0xAE525317, 0xAE525317, "IXAR11"},
   {0xB28A6512, 0xB28A6512, "IXAR12"},
   {0xA7E71056, 0xA7E71056, "IXAR13"},
   {0x7B88CD19, 0x7B88CD19, "IXAR14"}
};
