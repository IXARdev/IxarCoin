...
const string strMessageMagic = "Ixarcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
        nSubsidy = 1580000 * COIN; // premine
    }
    else if (nHeight > 1 && nHeight <= 1920) {
        nSubsidy = 5 * COIN; // instamine prevention
    }
    else if (nHeight > 1920 && nHeight <= 12000) {
        nSubsidy = 10 * COIN;
    }
    else if (nHeight > 12000 && nHeight <= 32000) {
        nSubsidy = 15 * COIN;
    }
    else if (nHeight > 32000 && nHeight <= 100000) {
        nSubsidy = 25 * COIN;
    }
    else if (nHeight > 100000 && nHeight <= 138000) {
        nSubsidy = 32 * COIN;
    }
    else if (nHeight > 138000 && nHeight <= 210000) {
        nSubsidy = 28 * COIN;
    }
    else if (nHeight > 210000 && nHeight <= 350000) {
        nSubsidy = 10 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 1920 && pindexBest->nHeight+1 <= 12000)  {
        nSubsidy = 30 * COIN;
    }
    else if (pindexBest->nHeight+1 > 12000 && pindexBest->nHeight+1 <= 32000)  {
        nSubsidy = 45 * COIN;
    }
    else if (pindexBest->nHeight+1 > 32000 && pindexBest->nHeight+1 <= 100000) {
        nSubsidy = 75 * COIN;
    }
    else if (pindexBest->nHeight+1 > 100000 && pindexBest->nHeight+1 <= 138000) {
        nSubsidy = 128 * COIN;
    }
    else if (pindexBest->nHeight+1 > 138000 && pindexBest->nHeight+1 <= 210000) {
        nSubsidy = 112 * COIN;
    }
    else if (pindexBest->nHeight+1 > 210000 && pindexBest->nHeight+1 <= 350000) {
        nSubsidy = 90 * COIN;
    }
    else if (pindexBest->nHeight+1 > 350000 && pindexBest->nHeight+1 <= 700000) {
        nSubsidy = 60 * COIN;
    }
    else if (pindexBest->nHeight+1 > 700000 && pindexBest->nHeight+1 <= 1050000) {
        nSubsidy = 40 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1050000 && pindexBest->nHeight+1 <= 1400000) {
        nSubsidy = 20 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1400000 && pindexBest->nHeight+1 <= 1750000) {
        nSubsidy = 10 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1750000 && pindexBest->nHeight+1 <= 2100000) {
        nSubsidy = 5 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2100000) {
        nSubsidy = 2.5 * COIN;
        nSubsidy >>= ((pindexBest->nHeight - 2100000 + 350000) / 350000);
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight < 1920) {
        ...
        ret = blockValue / 100 * 90; // MN Reward 90%
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        ...
        if (foundPaymentAndPayee) {
            ...
            CIxarcoinAddress address2(address1);
