...
If you want to build Ixarcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a ixarcoin-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the ixarcoin directory
BDB_PREFIX="${IXARCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Ixarcoin Core to use our own-built instance of BDB
cd $IXARCOIN_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip ixarcoind" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Ixarcoind with compile script
---------------------
...
Security
---------------------
To help make your ixarcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, ixarcoin should be built with a non-executable stack
